...
! function ($, options) {
    ...
    var TikTok = function (options) {
        ...
        function fireEvent(name, event) {
            ...
            if(typeof window.ptp_event_data_filter === "function" && window.pys_disable_event_filter(name,'tiktok')) {
                return;
            }
    ...
    var Facebook = function (options) {
        ...
        function fireEvent(name, event) {
            ...
            if(typeof window.ptp_event_data_filter === "function" && window.pys_disable_event_filter(name,'facebook')) {
                return;
            }
    ...
    var Analytics = function (options) {
         ...
         */
        function fireEvent(name, event) {
            if(typeof window.ptp_event_data_filter === "function" && window.pys_disable_event_filter(name,'ga')) {
                return;
            }
    ...
    var GAds = function (options) {
        ...
        function fireEvent(name, data) {
            if(typeof window.ptp_event_data_filter === "function" && window.pys_disable_event_filter(event_name,'google_ads')) {
                return;
            }
