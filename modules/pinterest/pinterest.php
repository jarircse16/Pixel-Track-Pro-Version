...
class Pinterest extends Settings implements Pixel {
	...
	public function renderAddonNotice() {
	    echo '&nbsp;<a href="https://www.webmxt.com/pinterest-tag" target="_blank" class="badge badge-pill badge-secondary">Requires paid add-on</a>';
    }
    ...
    public function renderPixelIdField() {
        ...
        <div class="row align-items-center">
            ...
            <div class="col-10">
                <h4 class="label">Add the Pinterest tag with our <a href="https://www.webmxt.com/pinterest-tag?utm_source=pixelyoursite-pro-plugin&utm_medium=plugin&utm_campaign=pro-plugin-pinterest" target="_blank">Paid add-on.</a></h4>
            </div>
        </div>
        <hr>
