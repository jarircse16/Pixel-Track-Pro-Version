...
class Bing extends Settings implements Pixel {
	...
	public function renderAddonNotice() {
	    echo '&nbsp;<a href="https://www.webmxt.com/bing-tag" target="_blank" class="badge badge-pill badge-secondary">Requires paid add-on</a>';
    }
    ...
    public function renderPixelIdField() {
        ?>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-10">
                    <h4 class="label">Microsoft the UET Tag (Bing) with <a href="https://www.webmxt.com/bing-tag?utm_source=pixelyoursite-pro-plugin&utm_medium=plugin&utm_campaign=pro-plugin-bing" target="_blank">this pro add-on.</a></h4>
                </div>
            </div>
            <hr>
